            ...
            <div class="flex shrink-0 items-center justify-between border-b-2 border-[#0d0d0d] bg-[#faf8f5] px-5 py-4 sm:px-6">
                <div class="min-w-0 pr-4">
                    ...
                    <p class="mt-0.5 truncate font-mono text-xs text-[#57534e]">
                        [PENULIS: <strong class="text-[#0d0d0d] uppercase">{{ authorName }}</strong>]
                    </p>
                </div>
            ...
            <div class="custom-scrollbar flex-1 overflow-y-auto p-3 sm:p-4">
                ...
                <div v-else class="space-y-2">
                    <label v-for="book in filteredBooks" :key="book.id"
                        ...
                        :class="selectedIds.includes(book.id!) ? 'border-[#00875a] bg-[#eafaf1] shadow-[2px_2px_0px_#00875a]' : 'border-[#0d0d0d] bg-white shadow-[1px_1px_0px_#0d0d0d] hover:bg-[#f3ede2]'">
            ...
            <div class="flex shrink-0 items-center justify-between gap-3 border-t-2 border-[#0d0d0d] bg-[#faf8f5] p-4 sm:px-6">
                ...
                <div class="flex gap-2.5">
                    ...
                    <button type="button" @click="handleAssign" :disabled="selectedIds.length === 0"
                        class="cursor-pointer rounded-[4px] border-2 border-[#0d0d0d] bg-[#0d0d0d] px-4 py-2 font-mono text-xs font-bold uppercase tracking-wider text-white shadow-[2px_2px_0px_#0d0d0d] transition-all hover:bg-[#262626] hover:shadow-[3px_3px_0px_#ff4800] disabled:cursor-not-allowed disabled:opacity-40">
